...
def stft_analysis(time_signal, size=320, shift=160, fading=False, ceil=False,
...
def stft_synthesis(stft_signal, size=320, shift=160, fading=False,
    ...
    window = window_func(size, shift)
    time_signal = np.zeros(signal_length + shift)
    j = 0
